...
- 2025/09/23
  - 爆裂駒拾太郎 V 3.1.0にアップデート
    ...
    - 静止探索で残り深さが0になった場合は駒の取り返しのみ生成するように変更
    - Razoringによる前向き枝刈りを追加
    - Futility Pruningによる前向き枝刈りを追加
    - Null Move Pruningのパラメータを変更
    - 置換表のサイズを変更
    - 起動時ではなくisredyコマンドで定跡を読み込むように変更
  - 爆裂駒拾太郎 V 3.1.0のレーティングを計測(R1787)
- 2025/06/25
